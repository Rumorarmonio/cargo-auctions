...
- Добавлен route `/auctions/:auctionUuid/bet` с временной заглушкой для перехода из detail; форма и mutation ставки остаются следующим шагом.

## Следующий шаг

Следующий этап — реализовать detail-страницу, историю ставок и отдельный route формы ставки.

Текущий подшаг этапа 7 завершён: detail-заглушка заменена полноценной страницей и добавлен route ставки-заглушки. Следующий подшаг — реализовать форму и mutation ставки.
